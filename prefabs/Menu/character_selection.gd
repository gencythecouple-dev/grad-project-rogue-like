...
func _ready() -> void:
	...
	select_mage.mouse_entered.connect(func(): panel1.show())
	select_mage.mouse_exited.connect(func(): panel1.hide())
	select_rogue.mouse_entered.connect(func(): panel2.show())
	select_rogue.mouse_exited.connect(func(): panel2.hide())
	select_warrior.mouse_entered.connect(func(): panel3.show())
